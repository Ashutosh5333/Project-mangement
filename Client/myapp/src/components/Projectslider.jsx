...
const Projectslider = () => {
 ...
 const responsive = {
  ...
  <SwiperSlide>
      <Card style={{ boxShadow: "rgba(0, 0, 0, 0.15) 0px 5px 15px 0px" }} borderLeft="6px solid skyblue" w={{ base: "100%" }} h="100px" ml={{base:"15px"}} mb={"5"} > 
            <Text pl={"10px"} align={{base:"start"}} fontSize=".8rem" >Total Projects</Text>
            <Text pl={"10px"} align={{base:"start"}} fontWeight="600"  fontSize="30px" mt="2">{TProject.totalProjects} </Text>
      </Card>
      </SwiperSlide>

      <SwiperSlide>
      <Card style={{ boxShadow: "rgba(0, 0, 0, 0.15) 0px 5px 15px 0px" }} borderLeft="6px solid skyblue" w={{ base: "100%" }} h="100px" ml="15px"> 
            <Text pl={"10px"} align={{base:"start"}} >Closed</Text>
            <Text pl={"10px"} fontWeight="600" align={{base:"start"}}  fontSize="30px">  {Closed.ClosedProject} </Text>
      </Card>
      </SwiperSlide>

      <SwiperSlide>
      <Card style={{ boxShadow: "rgba(0, 0, 0, 0.15) 0px 5px 15px 0px" }} borderLeft="6px solid skyblue" w={{ base: "100%"}} h="100px" ml="15px"> 
            <Text  pl={"10px"} align={{base:"start"}} >Running</Text>
            <Text pl={"10px"} align={{base:"start"}} fontWeight="600" fontSize="30px">{running.RunningProject}</Text>
      </Card>
      </SwiperSlide>

      <SwiperSlide>
      <Card style={{ boxShadow: "rgba(0, 0, 0, 0.15) 0px 5px 15px 0px" }} borderLeft="6px solid skyblue" w={{ base: "100%" }} h="100px" ml="15px"> 
            <Text pl={"10px"} align={{base:"start"}} >Closure</Text>
            <Text pl={"10px"} align={{base:"start"}} fontWeight="600" fontSize="30px">  {Closed.ClosedProject} </Text>
      </Card>
      </SwiperSlide>
      <SwiperSlide>
      <Card style={{ boxShadow: "rgba(0, 0, 0, 0.15) 0px 5px 15px 0px" }} borderLeft="6px solid skyblue" w={{ base: "100%" }} h="100px" ml="15px"> 
            <Text pl={"10px"} align={{base:"start"}} >Cancelled</Text>
            <Text pl={"10px"} align={{base:"start"}} fontWeight="600" fontSize="30px"> {Cancel.canceledProject} </Text>
      </Card>
      </SwiperSlide>
